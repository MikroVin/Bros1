            ...
            <div class="flex items-center">
                ...
                <div class="hidden md:block">
                    <div class="ml-10 flex items-baseline space-x-4">
                        ...
                        <a href="/" class="rounded-md px-3 py-2 text-sm font-medium<?php $_SERVER['REQUEST_URI'] === '/' ?  "text-gray-300 hover:bg-gray-700 hover:text-white"  ?> ">Home</a>
                        <a href="/receipt.php" class="rounded-md px-3 py-2 text-sm font-medium bg-gray-900 text-white">Receipt</a>
                    </div>
                </div>
            </div>
            <div class="hidden md:block">
    ...
    <div class="md:hidden" id="mobile-menu">
        ...
        <div class="border-t border-gray-700 pb-3 pt-4">
            <div class="flex items-center px-5">
                ...
                <div class="ml-3">
                    <div class="text-base/5 font-medium text-white">Monkey</div>
                    <div class="text-sm font-medium text-gray-400">Admin 4</div>
                </div>
